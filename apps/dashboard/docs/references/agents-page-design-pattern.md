...
## Primary Reference: Memory Page

**Reference Page**: http://localhost:3000/workspace/memory
**Component**: `apps/dashboard/features/pages/workspace/memory/page.tsx`
...
## Design Philosophy (Memory Page)

The `/workspace/memory` page demonstrates:
...
**After** (Following `/workspace/memory` pattern):
```tsx
export default function MyPage() {
  return (
