...
"""
Manage Backlog
Creates a placeholder backlog entry for knowledge tasks.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Manage knowledge backlog")
    ...
    output_path = backlog_dir / f"{task['id']}.json"
    ...
    if args.json:
        ...
        _out(f"Backlog task created: {output_path}")
