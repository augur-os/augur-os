...
def can_fit_in_budget(
    current_tokens: int, additional_tokens: int, max_tokens: int = 190000, safety_margin: int = 10000
) -> bool:
    """
...
def estimate_total_workflow_tokens(cv_count: int, is_new_company: bool = False) -> Dict:
    ...
    """
    tokens = {'init': 5000, 'cvs': estimate_cv_load_tokens(cv_count), 'modules': 8000, 'analysis': 5000, 'excel': 2000}
    ...
    return {'breakdown': tokens, 'total': total, 'cv_count': cv_count, 'is_new_company': is_new_company}
