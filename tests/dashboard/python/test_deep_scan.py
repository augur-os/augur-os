"""Importability test for apps/dashboard/scripts/skill-scripts/import_stages/deep_scan.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/import_stages/deep_scan.py"
...
def test_deep_scan_importable():
    """Verify that deep_scan can be imported without errors."""
