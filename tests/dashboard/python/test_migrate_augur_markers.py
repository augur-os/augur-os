"""Importability test for apps/dashboard/scripts/skill-scripts/migrate_augur_markers.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/migrate_augur_markers.py"
...
def test_migrate_augur_markers_importable():
    """Verify that migrate_augur_markers can be imported without errors."""
