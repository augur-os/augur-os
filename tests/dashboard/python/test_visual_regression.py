"""Importability test for apps/dashboard/scripts/skill-scripts/visual_regression.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/visual_regression.py"
...
def test_visual_regression_importable():
    """Verify that visual_regression can be imported without errors."""
