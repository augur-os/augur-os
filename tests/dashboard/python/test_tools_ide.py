"""Importability test for apps/dashboard/scripts/skill-scripts/mcp/tools_ide.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/mcp/tools_ide.py"
...
def test_tools_ide_importable():
    """Verify that tools_ide can be imported without errors."""
