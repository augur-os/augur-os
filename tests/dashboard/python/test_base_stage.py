"""Importability test for apps/dashboard/scripts/skill-scripts/stages/base_stage.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/stages/base_stage.py"
...
def test_base_stage_importable():
    """Verify that base_stage can be imported without errors."""
