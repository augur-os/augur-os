"""Importability test for apps/dashboard/scripts/skill-scripts/scoring/scoring_plugin.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/scoring/scoring_plugin.py"
...
def test_scoring_plugin_importable():
    """Verify that scoring_plugin can be imported without errors."""
