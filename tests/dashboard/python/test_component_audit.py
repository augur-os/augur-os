"""Importability test for apps/dashboard/scripts/skill-scripts/component_audit.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/component_audit.py"
...
def test_component_audit_importable():
    """Verify that component_audit can be imported without errors."""
