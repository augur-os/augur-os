"""Importability test for apps/dashboard/scripts/skill-scripts/questionnaires/questions.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/questionnaires/questions.py"
...
def test_questions_importable():
    """Verify that questions can be imported without errors."""
