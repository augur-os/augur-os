"""Importability test for apps/dashboard/scripts/skill-scripts/skill_import.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_import.py"
...
def test_skill_import_importable():
    """Verify that skill_import can be imported without errors."""
