"""Importability test for apps/dashboard/scripts/skill-scripts/scoring/analyzer.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/scoring/analyzer.py"
...
def test_analyzer_importable():
    """Verify that analyzer can be imported without errors."""
