"""Importability test for apps/dashboard/scripts/skill-scripts/porter_markdown.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/porter_markdown.py"
...
def test_porter_markdown_importable():
    """Verify that porter_markdown can be imported without errors."""
