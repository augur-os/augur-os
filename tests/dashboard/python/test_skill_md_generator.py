"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/skill_md_generator.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/skill_md_generator.py"
...
def test_skill_md_generator_importable():
    """Verify that skill_md_generator can be imported without errors."""
