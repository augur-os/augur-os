"""Importability test for apps/dashboard/scripts/skill-scripts/generate_skill_ui.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/generate_skill_ui.py"
...
def test_generate_skill_ui_importable():
    """Verify that generate_skill_ui can be imported without errors."""
