"""Importability test for apps/dashboard/scripts/skill-scripts/stages/stage_3_data.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/stages/stage_3_data.py"
...
def test_stage_3_data_importable():
    """Verify that stage_3_data can be imported without errors."""
