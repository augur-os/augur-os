"""Importability test for apps/dashboard/scripts/skill-scripts/porter_ops.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/porter_ops.py"
...
def test_porter_ops_importable():
    """Verify that porter_ops can be imported without errors."""
