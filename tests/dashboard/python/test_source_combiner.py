"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/source_combiner.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/source_combiner.py"
...
def test_source_combiner_importable():
    """Verify that source_combiner can be imported without errors."""
