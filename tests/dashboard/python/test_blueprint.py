"""Importability test for apps/dashboard/scripts/skill-scripts/import_stages/blueprint.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/import_stages/blueprint.py"
...
def test_blueprint_importable():
    """Verify that blueprint can be imported without errors."""
