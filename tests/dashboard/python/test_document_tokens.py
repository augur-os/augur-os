"""Importability test for apps/dashboard/scripts/skill-scripts/document_tokens.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/document_tokens.py"
...
def test_document_tokens_importable():
    """Verify that document_tokens can be imported without errors."""
