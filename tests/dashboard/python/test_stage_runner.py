"""Importability test for apps/dashboard/scripts/skill-scripts/workflow/stage_runner.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/workflow/stage_runner.py"
...
def test_stage_runner_importable():
    """Verify that stage_runner can be imported without errors."""
