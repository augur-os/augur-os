"""Importability test for apps/dashboard/scripts/skill-scripts/import_codegen.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/import_codegen.py"
...
def test_import_codegen_importable():
    """Verify that import_codegen can be imported without errors."""
