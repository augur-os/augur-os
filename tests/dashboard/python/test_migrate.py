"""Importability test for apps/dashboard/scripts/skill-scripts/migrate.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/migrate.py"
...
def test_migrate_importable():
    """Verify that migrate can be imported without errors."""
