"""Importability test for apps/dashboard/scripts/skill-scripts/file_analyzers/excel.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/file_analyzers/excel.py"
...
def test_excel_importable():
    """Verify that excel can be imported without errors."""
