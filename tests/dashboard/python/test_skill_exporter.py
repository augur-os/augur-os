"""Importability test for apps/dashboard/scripts/skill-scripts/skill_exporter.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_exporter.py"
...
def test_skill_exporter_importable():
    """Verify that skill_exporter can be imported without errors."""
