"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/analyze_rag_content.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/analyze_rag_content.py"
...
def test_analyze_rag_content_importable():
    """Verify that analyze_rag_content can be imported without errors."""
