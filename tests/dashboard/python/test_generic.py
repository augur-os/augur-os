"""Importability test for apps/dashboard/scripts/skill-scripts/file_analyzers/generic.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/file_analyzers/generic.py"
...
def test_generic_importable():
    """Verify that generic can be imported without errors."""
