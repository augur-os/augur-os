"""Importability test for apps/dashboard/scripts/skill-scripts/transform.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/transform.py"
...
def test_transform_importable():
    """Verify that transform can be imported without errors."""
