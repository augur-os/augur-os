"""Importability test for apps/dashboard/scripts/skill-scripts/import_stages/write_adr.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/import_stages/write_adr.py"
...
def test_write_adr_importable():
    """Verify that write_adr can be imported without errors."""
