"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generator.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generator.py"
...
def test_skill_generator_importable():
    """Verify that skill_generator can be imported without errors."""
