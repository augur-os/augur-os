"""Importability test for apps/dashboard/scripts/skill-scripts/generate_skill_readmes.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/generate_skill_readmes.py"
...
def test_generate_skill_readmes_importable():
    """Verify that generate_skill_readmes can be imported without errors."""
