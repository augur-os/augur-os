"""Importability test for apps/dashboard/scripts/skill-scripts/skill_exporter_targets.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_exporter_targets.py"
...
def test_skill_exporter_targets_importable():
    """Verify that skill_exporter_targets can be imported without errors."""
