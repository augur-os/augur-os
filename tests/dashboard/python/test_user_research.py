"""Importability test for apps/dashboard/scripts/skill-scripts/scoring/user_research.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/scoring/user_research.py"
...
def test_user_research_importable():
    """Verify that user_research can be imported without errors."""
