"""Importability test for apps/dashboard/scripts/skill-scripts/porter_source.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/porter_source.py"
...
def test_porter_source_importable():
    """Verify that porter_source can be imported without errors."""
