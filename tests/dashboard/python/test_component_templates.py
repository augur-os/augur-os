"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/component_templates.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/component_templates.py"
...
def test_component_templates_importable():
    """Verify that component_templates can be imported without errors."""
