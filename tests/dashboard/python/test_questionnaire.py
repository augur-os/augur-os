"""Importability test for apps/dashboard/scripts/skill-scripts/scoring/questionnaire.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/scoring/questionnaire.py"
...
def test_questionnaire_importable():
    """Verify that questionnaire can be imported without errors."""
