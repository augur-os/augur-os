"""Importability test for apps/dashboard/scripts/skill-scripts/mcp/tools_plugin.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/mcp/tools_plugin.py"
...
def test_tools_plugin_importable():
    """Verify that tools_plugin can be imported without errors."""
