"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/route_templates.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/route_templates.py"
...
def test_route_templates_importable():
    """Verify that route_templates can be imported without errors."""
