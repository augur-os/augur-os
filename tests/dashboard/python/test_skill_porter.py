"""Importability test for apps/dashboard/scripts/skill-scripts/skill_porter.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_porter.py"
...
def test_skill_porter_importable():
    """Verify that skill_porter can be imported without errors."""
