"""Importability test for apps/dashboard/scripts/skill-scripts/file_analyzers/directory.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/file_analyzers/directory.py"
...
def test_directory_importable():
    """Verify that directory can be imported without errors."""
