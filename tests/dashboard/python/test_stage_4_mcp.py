"""Importability test for apps/dashboard/scripts/skill-scripts/stages/stage_4_mcp.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/stages/stage_4_mcp.py"
...
def test_stage_4_mcp_importable():
    """Verify that stage_4_mcp can be imported without errors."""
