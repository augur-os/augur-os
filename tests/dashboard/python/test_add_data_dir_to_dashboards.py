"""Importability test for apps/dashboard/scripts/skill-scripts/add_data_dir_to_dashboards.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/add_data_dir_to_dashboards.py"
...
def test_add_data_dir_to_dashboards_importable():
    """Verify that add_data_dir_to_dashboards can be imported without errors."""
