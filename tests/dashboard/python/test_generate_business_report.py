"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/generate_business_report.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/generate_business_report.py"
...
def test_generate_business_report_importable():
    """Verify that generate_business_report can be imported without errors."""
