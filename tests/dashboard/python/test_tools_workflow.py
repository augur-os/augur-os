"""Importability test for apps/dashboard/scripts/skill-scripts/mcp/tools_workflow.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/mcp/tools_workflow.py"
...
def test_tools_workflow_importable():
    """Verify that tools_workflow can be imported without errors."""
