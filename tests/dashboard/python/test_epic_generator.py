"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/epic_generator.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/epic_generator.py"
...
def test_epic_generator_importable():
    """Verify that epic_generator can be imported without errors."""
