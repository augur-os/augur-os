"""Importability test for apps/dashboard/scripts/skill-scripts/source_adapters/folder.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/source_adapters/folder.py"
...
def test_folder_importable():
    """Verify that folder can be imported without errors."""
