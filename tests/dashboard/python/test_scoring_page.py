"""Importability test for apps/dashboard/scripts/skill-scripts/scoring/scoring_page.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/scoring/scoring_page.py"
...
def test_scoring_page_importable():
    """Verify that scoring_page can be imported without errors."""
