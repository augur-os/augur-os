"""Importability test for apps/dashboard/scripts/skill-scripts/mcp/tools_migrate.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/mcp/tools_migrate.py"
...
def test_tools_migrate_importable():
    """Verify that tools_migrate can be imported without errors."""
