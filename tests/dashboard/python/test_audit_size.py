"""Importability test for apps/dashboard/scripts/skill-scripts/audit_size.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/audit_size.py"
...
def test_audit_size_importable():
    """Verify that audit_size can be imported without errors."""
