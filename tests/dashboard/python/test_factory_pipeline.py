"""Importability test for apps/dashboard/scripts/skill-scripts/factory_pipeline.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/factory_pipeline.py"
...
def test_factory_pipeline_importable():
    """Verify that factory_pipeline can be imported without errors."""
