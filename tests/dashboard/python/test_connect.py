"""Importability test for apps/dashboard/scripts/skill-scripts/import_stages/connect.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/import_stages/connect.py"
...
def test_connect_importable():
    """Verify that connect can be imported without errors."""
