"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/security_validator.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/security_validator.py"
...
def test_security_validator_importable():
    """Verify that security_validator can be imported without errors."""
