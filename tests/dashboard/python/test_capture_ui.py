"""Importability test for apps/dashboard/scripts/skill-scripts/capture_ui.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/capture_ui.py"
...
def test_capture_ui_importable():
    """Verify that capture_ui can be imported without errors."""
