"""Importability test for apps/dashboard/scripts/skill-scripts/process_icon.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/process_icon.py"
...
def test_process_icon_importable():
    """Verify that process_icon can be imported without errors."""
