"""Importability test for apps/dashboard/scripts/skill-scripts/scoring/comparator.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/scoring/comparator.py"
...
def test_comparator_importable():
    """Verify that comparator can be imported without errors."""
