"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/script_generator.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/script_generator.py"
...
def test_script_generator_importable():
    """Verify that script_generator can be imported without errors."""
