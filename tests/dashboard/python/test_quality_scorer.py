"""Importability test for apps/dashboard/scripts/skill-scripts/scoring/quality_scorer.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/scoring/quality_scorer.py"
...
def test_quality_scorer_importable():
    """Verify that quality_scorer can be imported without errors."""
