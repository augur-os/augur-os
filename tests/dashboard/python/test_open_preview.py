"""Importability test for apps/dashboard/scripts/skill-scripts/open_preview.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/open_preview.py"
...
def test_open_preview_importable():
    """Verify that open_preview can be imported without errors."""
