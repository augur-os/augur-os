"""Importability test for apps/dashboard/scripts/skill-scripts/mcp/tools_templates.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/mcp/tools_templates.py"
...
def test_tools_templates_importable():
    """Verify that tools_templates can be imported without errors."""
