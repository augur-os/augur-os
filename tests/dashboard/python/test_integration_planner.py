"""Importability test for apps/dashboard/scripts/skill-scripts/integration_planner.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/integration_planner.py"
...
def test_integration_planner_importable():
    """Verify that integration_planner can be imported without errors."""
