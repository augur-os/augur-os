"""Importability test for apps/dashboard/scripts/skill-scripts/bridge_scan.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/bridge_scan.py"
...
def test_bridge_scan_importable():
    """Verify that bridge_scan can be imported without errors."""
