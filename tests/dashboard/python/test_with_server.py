"""Importability test for apps/dashboard/scripts/skill-scripts/with_server.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/with_server.py"
...
def test_with_server_importable():
    """Verify that with_server can be imported without errors."""
