"""Importability test for apps/dashboard/scripts/skill-scripts/excel_reader.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/excel_reader.py"
...
def test_excel_reader_importable():
    """Verify that excel_reader can be imported without errors."""
