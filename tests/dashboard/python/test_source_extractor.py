"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/source_extractor.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/source_extractor.py"
...
def test_source_extractor_importable():
    """Verify that source_extractor can be imported without errors."""
