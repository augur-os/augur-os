"""Importability test for apps/dashboard/scripts/skill-scripts/workflow/state_manager.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/workflow/state_manager.py"
...
def test_state_manager_importable():
    """Verify that state_manager can be imported without errors."""
