"""Importability test for apps/dashboard/scripts/skill-scripts/porter_utils.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/porter_utils.py"
...
def test_porter_utils_importable():
    """Verify that porter_utils can be imported without errors."""
