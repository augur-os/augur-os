"""Importability test for apps/dashboard/scripts/skill-scripts/import_workflow.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/import_workflow.py"
...
def test_import_workflow_importable():
    """Verify that import_workflow can be imported without errors."""
