"""Importability test for apps/dashboard/scripts/skill-scripts/skill_generation/unified_generator.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_generation/unified_generator.py"
...
def test_unified_generator_importable():
    """Verify that unified_generator can be imported without errors."""
