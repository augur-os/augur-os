"""Importability test for apps/dashboard/scripts/skill-scripts/delight.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/delight.py"
...
def test_delight_importable():
    """Verify that delight can be imported without errors."""
