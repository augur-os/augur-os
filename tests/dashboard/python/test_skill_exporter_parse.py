"""Importability test for apps/dashboard/scripts/skill-scripts/skill_exporter_parse.py (auto-generated)."""
...
MODULE_PATH = PROJECT_ROOT / "apps/dashboard/scripts/skill-scripts/skill_exporter_parse.py"
...
def test_skill_exporter_parse_importable():
    """Verify that skill_exporter_parse can be imported without errors."""
