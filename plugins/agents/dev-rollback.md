---
name: dev-rollback
description: 'Safe rollback and recovery from failed deployments or breaking changes'
mode: auto
model: sonnet
...
> Safe rollback and recovery from failed deployments or breaking changes
