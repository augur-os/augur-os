---
name: mcp-app-factory
description: 'Create, audit, migrate, and import Augur plugins with MCP-backed tooling and dashboard workflows.'
mode: auto
model: sonnet
mcpServers:
  - augur
...
> Create, audit, migrate, and import Augur plugins with MCP-backed tooling and dashboard workflows.
