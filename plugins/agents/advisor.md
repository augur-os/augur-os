---
name: advisor
description: 'Advisory and optimization agent for prompt quality, agent evaluation, and codebase exploration.'
mode: plan
model: sonnet
mcpServers:
  - augur
...
> Advisory and optimization agent for prompt quality, agent evaluation, and codebase exploration.
