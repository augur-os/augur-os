---
name: test-client
description: 'Test Client management for development workflow automation. Covers: /client-test, what it tests. Use when working with test client features or data.'
mode: auto
model: sonnet
...
> Test Client management for development workflow automation. Covers: /client-test, what it tests. Use when working with test client features or data.
