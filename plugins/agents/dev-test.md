---
name: dev-test
description: 'Run test verticals with hub scoping for development workflow automation. Covers: /dev-test, default mode (fast, ~2min)'
mode: auto
model: sonnet
...
> Run test verticals with hub scoping for development workflow automation. Covers: /dev-test, default mode (fast, ~2min)
